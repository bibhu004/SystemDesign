...
@Component
public class LiveClass implements Events {

    List<NotificationChannel> subscribers;

    public LiveClass(List<NotificationChannel> subscribers){
    ...
    public void publish(CourseName courseName ){
        ...
        notification.setMessage("Live Class started for "+ courseName);
