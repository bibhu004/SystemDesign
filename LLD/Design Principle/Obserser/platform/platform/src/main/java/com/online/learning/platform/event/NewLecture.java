...
@Component
public class NewLecture implements Events {

    List<NotificationChannel> subscribers;

    public NewLecture(List<NotificationChannel> subscribers){
    ...
    public void publish(CourseName courseName ){
        ...
        notification.setMessage("New Lecture added for "+ courseName);
