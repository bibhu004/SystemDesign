...
@Component
public class UPI implements Payable, Refundable{


    @Override
    public boolean makePayment(DetailsDTO detailsDTO){
        System.out.println("UPI payment of amount - " + detailsDTO.getAmount() + " to " + detailsDTO.getRecieverAccNo());
        return true;
    }
    ...
    public boolean getRefund(DetailsDTO detailsDTO){
        System.out.println("UPI Refund initiated for amount - " + detailsDTO.getAmount() + " for " + detailsDTO.getSenderAccNo());
        return true;
    }
}
